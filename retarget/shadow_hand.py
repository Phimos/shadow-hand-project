...
class ShadowHandModule(nn.Module):
    def __init__(self) -> None:
        ...
        joints.append(Joint("WRJ0", 0, [1.0000, 0.0000, 0.0000], -0.6890, 0.4890))
        joints.append(Joint("FFJ3", 1, [0.0000, 1.0000, 0.0000], -0.3490, 0.3490))
        joints.append(Joint("FFJ2", 2, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("FFJ1", 3, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("FFJ0", 4, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("MFJ3", 6, [0.0000, 1.0000, 0.0000], -0.3490, 0.3490))
        joints.append(Joint("MFJ2", 7, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("MFJ1", 8, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("MFJ0", 9, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("RFJ3", 11, [0.0000, 1.0000, 0.0000], -0.3490, 0.3490))
        joints.append(Joint("RFJ2", 12, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("RFJ1", 13, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("RFJ0", 14, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("LFJ4", 16, [0.5710, 0.0000, 0.8210], 0.0000, 0.7850))
        joints.append(Joint("LFJ3", 17, [0.0000, 1.0000, 0.0000], -0.3490, 0.3490))
        joints.append(Joint("LFJ2", 18, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("LFJ1", 19, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("LFJ0", 20, [1.0000, 0.0000, 0.0000], 0.0000, 1.5710))
        joints.append(Joint("THJ4", 22, [0.0000, 0.0000, -1.0000], -1.0470, 1.0470))
        joints.append(Joint("THJ3", 23, [1.0000, 0.0000, 0.0000], 0.0000, 1.2220))
        joints.append(Joint("THJ2", 24, [1.0000, 0.0000, 0.0000], -0.2090, 0.2090))
        joints.append(Joint("THJ1", 25, [0.0000, 1.0000, 0.0000], -0.5240, 0.5240))
        joints.append(Joint("THJ0", 26, [0.0000, 1.0000, 0.0000], -1.5710, 0.0000))
